...
abstract: "はじめに――自分の配線が障害の原因になった 今回、学内の壁面LANポートにスイッチングハブを直接つなぎ、その下にルーターと複数の端末を接続しました。この配線が、ネットワーク障害の原因になりました。 当時は「LANポートを増やす」という目的だけを見て、スイッチングハブを先に置いてしまいました。しかし、スイッチングハブは上流ネットワークと自分の機器を隔離する装置"
publishedAt: "2026-08-02"
canonicalUrl: "https://zenn.dev/t_tokunaga/articles/2026-08-02-switch-before-router-network-incident"
tags:
  - "network"
  - "router"
  - "switch"
...
![スイッチングハブをルーターの上流に置いた誤った構成と、ルーターの下流に置く正しい構成の比較](/images/blog/2026-08-02-switch-before-router-network-incident/2026-08-02-switch-before-router-network-incident/network-topology-comparison.png)
...
![PC、スマートフォン、NASのプライベートIPアドレスをルーターがNAT・NAPTで変換し、一つの上流側IPアドレスを共有する流れ](/images/blog/2026-08-02-switch-before-router-network-incident/2026-08-02-switch-before-router-network-incident/nat-napt-address-translation.png)
...
![DHCPがPCへIPアドレスを割り当て、PCが通信を開始し、ルーターがNAT・NAPTで送信元を変換する3段階の流れ](/images/blog/2026-08-02-switch-before-router-network-incident/2026-08-02-switch-before-router-network-incident/dhcp-nat-communication-flow.png)
...
![ONU・モデム、スイッチングハブ・アクセスポイント、ルーターの役割の違い](/images/blog/2026-08-02-switch-before-router-network-incident/2026-08-02-switch-before-router-network-incident/network-device-role-summary.png)
*信号を変換する機器、同じLANを広げる機器、異なるネットワークを接続する機器は役割が異なる*

スイッチングハブとルーターの構造的な違いは、次の図のようになります。

![スイッチングハブが一つのレイヤー2ネットワークを広げる構成と、ルーターが学内ネットワークと自分のネットワークを接続する構成の比較](/images/blog/2026-08-02-switch-before-router-network-incident/2026-08-02-switch-before-router-network-incident/switch-router-network-boundary.png)
