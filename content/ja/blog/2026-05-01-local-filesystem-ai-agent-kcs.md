...
abstract: "AI Agentを使っていると、モデルの賢さに驚く一方で、かなり早い段階で別の壁にぶつかります。 それは、ローカルファイルシステムがAIにとってあまりにも扱いづらいという壁です。 LLMの性能は毎年上がっています。コード生成も、推論も、長文読解も、数年前とは別物です。それでも、AI Agentに自分のPC内の資料、PDF、画像、Officeファイル、過去のメ"
publishedAt: "2026-05-01"
canonicalUrl: "https://zenn.dev/t_tokunaga/articles/2026-05-01-local-filesystem-ai-agent-kcs"
tags:
  - "ai"
  - "agent"
  - "filesystem"
