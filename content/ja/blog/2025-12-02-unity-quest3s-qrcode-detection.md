...
abstract: "Unity と Meta Quest 3S で QR コード検出を安定して扱うための実装ガイドです。MR Utility Kit（MRUK）に合わせた実装と運用上のポイントをまとめます。 更新日: 2026年1月（内容を現在の実装に合わせて更新） 対象読者: Unity MR 開発者（初級〜中級） 動作確認環境（参考）: HMD: Meta Quest 3S"
publishedAt: "2025-12-02"
canonicalUrl: "https://zenn.dev/t_tokunaga/articles/2025-12-02-unity-quest3s-qrcode-detection"
tags:
  - "Unity"
  - "Meta Quest"
  - "MR"
